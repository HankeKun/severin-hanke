export const countdownsAppHtml = `
    <strong>Privacy Policy</strong>
    <p>
        SH Coding built the Countdowns app as
        an Ad Supported app. This SERVICE is provided by
        SH Coding at no cost and is intended for use as
        is.
    </p>
    <p>
    ...
    <p>
        ...
        Countdowns unless otherwise defined in this Privacy Policy.
    </p>
    <p>
    ...
    <p>
        ...
        identifiable information, including but not limited to E-Mail, Usage Data. The information that
    ...
    <p>
        ...
        Privacy Policy, do not hesitate to contact us at mail@severin-hanke.de.
    </p>
    <p>
