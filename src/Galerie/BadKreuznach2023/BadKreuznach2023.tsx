import "./BadKreuznach2023.css";
import "./BadKreuznach2023Media.css";
...
function BadKreuznach2023() {
    ...
    return (
        <div id="bad-kreuznach-2023-div">
            <Header/>
            <div id="bad-kreuznach-2023-content">
                <h1>Galerie</h1>
                <div id="bad-kreuznach-2023-images">
...
export default BadKreuznach2023;